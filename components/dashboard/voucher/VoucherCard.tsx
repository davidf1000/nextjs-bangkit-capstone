import { VoucherCardProps } from "./voucher.types";
...
const VoucherCard = ({
  ...
  return (
    <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 w-72 m-4">
      <div className="h-36 rounded-lg" style={backStyle}>
      ...
      <h2 className="text-4xl text-center my-2" my-1>
        {voucher.price} point
      </h2>
      <h3 className="text-3xl text-center font-bold mb-1 mt-6" my-1>
        {voucher.stock}
      </h3>
      <h4 className="text-md text-center font-bold" my-1>
        Vouchers remaining
      </h4>
      ...
      <div className="flex items-center justify-center my-2">
        <button
          onClick={(e) => {
            editVoucher(e, voucher.voucherId);
          }}
        ...
        <button
          onClick={(e) => {
            deleteVoucher(e, voucher.voucherId);
          }}
